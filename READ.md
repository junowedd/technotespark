...
```
technotespark/
├─ index.html                 # External portfolio home (GitHub Pages)
├─ case-studies/              # Detailed technical case studies
├─ projects/                  # EDA, sales, and automation projects
├─ docs/                      # Deep-dive technical documentation
│   └─ eda-comparison.html    # EDA tool comparison (external-facing)
└─ README.md                  # This document (internal overview)
```
...
➡ **Detailed external comparison page**  
...
- **ETRI–Amkor Chiplet Integration Verification**  
